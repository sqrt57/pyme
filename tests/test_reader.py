...
class TestReader(unittest.TestCase):
    ...
    def test_empty(self):
        stream = io.StringIO("")
        result = self.reader.read(stream)
    ...
    def test_empty_list(self):
        stream = io.StringIO("()")
        write.write_to(self.reader.read(stream), self.port)
    ...
    def test_symbols_eq(self):
        ...
        result1 = self.reader.read(stream)
        result2 = self.reader.read(stream)
